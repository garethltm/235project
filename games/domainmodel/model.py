...
class Game:
    ...
    @isWindows.setter
    def isWindows(self, isWindows: bool):
    ...
    @isLinux.setter
    def isLinux(self, isLinux: bool):
        self.__isLinux = isLinux
...
class User:
    ...
    def add_review(self, new_review):
        if not isinstance(new_review, Review) or new_review in self.__reviews:
            return
        self.__reviews.insert(0, new_review)
        new_review.game.reviews.insert(0, new_review)
